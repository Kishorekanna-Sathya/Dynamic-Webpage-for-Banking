...
<html>
<head>
	<title>Virtual_bank</title>
	<?php require 'assets/autoloader.php'; ?>
	<?php require 'assets/function.php'; ?>
	<?php
       $con = new mysqli('localhost','root','','mybank');
    define('bankname', 'Virtual Bank',true);
...
<body style=" background: url(images/bgimg.jpg);background-size: 100% ;
...
<div id="accordion" role="tablist" class="w-25 float-left shadowGreen" style="margin-left: 150px">
 ...
 <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="subhash@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="surya" class="form-control" required placeholder="Enter Password">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
         <form method="POST">
       	<input type="email" value="manager@virtualbank.com" name="email" class="form-control" required placeholder="Enter Email">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
        <form method="POST">
       	<input type="email" value="cashier@virtualbank.com" name="email" class="form-control" required placeholder="Enter Email">
...
<footer style="clear: both; float: left; margin-top: 160px; text-align: center; width: 100%; color: #fff;">
	<section class="about" id="about">
			<h6>About the Creater</h6>
		   <h5> <section class="about-bottom">
					<p>This website was created by KISHOREKANNA</p>
					<p>Contact : imkishorekanna@gmail.com</p>
					<P>LinkedIn:<a href="https://www.linkedin.com/in/kishorekanna-sathya-5a7591192/">Kishorekanna-sathya</a> </p>
			</section> 
			</h5>
	</section>
	<h6>
