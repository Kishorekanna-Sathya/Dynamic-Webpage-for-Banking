...
<div class="row w-100" >
  <div class="col" style="padding: 24px;padding-top: 0">
    <div class="jumbotron shadowGreen" style="padding: 25px;min-height: 241px;max-height: 241px">
  <h3 class="display-5">Welecome to Virtual Bank</h3>
  ...
  <?php 
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowGreen" data-ride="carousel" >
